...
|   | H | G | F | E | D | C | B | A |   |
|---|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| **1** | <img src="img/white/rook.svg" width=50px> | <img src="img/white/knight.svg" width=50px> | <img src="img/white/bishop.svg" width=50px> | <img src="img/white/king.svg" width=50px> | <img src="img/white/queen.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/white/rook.svg" width=50px> | **1** |
...
| **5** | <img src="img/blank.png" width=50px> | <img src="img/white/bishop.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/white/knight.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/black/pawn.svg" width=50px> | <img src="img/blank.png" width=50px> | **5** |
...
| **7** | <img src="img/black/pawn.svg" width=50px> | <img src="img/black/pawn.svg" width=50px> | <img src="img/black/pawn.svg" width=50px> | <img src="img/black/pawn.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/black/pawn.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/blank.png" width=50px> | **7** |
...
| :----: | :---------------------- |
| **A8** | [A2](https://github.com/RumiDaNeko/RumiDaNeko/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.Replace+%2B+with+space+if+you+see+it.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A8+to+A2), [A3](https://github.com/RumiDaNeko/RumiDaNeko/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.Replace+%2B+with+space+if+you+see+it.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A8+to+A3), [A4](https://github.com/RumiDaNeko/RumiDaNeko/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.Replace+%2B+with+space+if+you+see+it.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A8+to+A4), [A5](https://github.com/RumiDaNeko/RumiDaNeko/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.Replace+%2B+with+space+if+you+see+it.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A8+to+A5), [A6](https://github.com/RumiDaNeko/RumiDaNeko/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.Replace+%2B+with+space+if+you+see+it.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A8+to+A6), [A7](https://github.com/RumiDaNeko/RumiDaNeko/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.Replace+%2B+with+space+if+you+see+it.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A8+to+A7) |
| **B4** | [B3](https://github.com/RumiDaNeko/RumiDaNeko/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.Replace+%2B+with+space+if+you+see+it.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+B4+to+B3) |
...
| **G7** | [G6](https://github.com/RumiDaNeko/RumiDaNeko/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.Replace+%2B+with+space+if+you+see+it.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+G7+to+G6) |
